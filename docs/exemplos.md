# Exemplos de Uso {#exemplos_lista}
...
- **Arquivo:** \ref exemplo_5.c
- **Funcionalidades:** `sd_dir_list`, `sd_get_capacity_mb`, `sd_file_delete`, `sd_set_filename`.

---
*Para ver o cádigo-fonte completo, clique nos links dos arquivos acima ou acesse a aba **Exemplos** no menu superior.*
