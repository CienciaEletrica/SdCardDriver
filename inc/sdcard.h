...
typedef enum {
    ...
    SD_ERR_VOLTAGE   = 0x02, /**< Cartão não aceita a tensão */
 ...
 * @param max_len Tamanho máximo disponível no buffer
 ...
 * @param buffer Buffer externo onde os dados serão armazenados
 * @param buffer_size Tamanho máximo do buffer em bytes
 *
 * @return
...
/**
 * @brief Cria um novo arquivo no diretorio raiz com expansao de cluster.
 * 
 * @param ctx       Ponteiro para o contexto da biblioteca.
 * @param fs        Ponteiro para a estrutura FAT32 montada.
