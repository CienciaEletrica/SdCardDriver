...
Bem-vindo à documentação oficial da biblioteca **AVR SD Card**. Este driver foi desenvolvido para permitir que microcontroladores da linha AVR (como o ATmega328P) manipulem arquivos em cartões SD formatados em **FAT32**.
...
- \subpage exemplos_lista "Clique aqui para ver a lista de exemplos detalhada"
